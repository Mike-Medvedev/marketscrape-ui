...
import { useSearch, useCreateSearch, useUpdateSearch } from '../hooks/search.hook'
...
export function NewSearchPage() {
  ...
  // useQuery (not useSuspenseQuery) because of conditional `enabled`
          ...
          <Stack gap="lg">
            ...
            <Group grow>
              <TextInput
                label={
                  <span>
                    Min Price <Text span size="xs" c="dimmed">(optional)</Text>
                  </span>
                }
                type="number"
              ...
              <TextInput
                label={
                  <span>
                    Max Price <Text span size="xs" c="dimmed">(optional)</Text>
                  </span>
                }
                type="number"
          ...
          <Stack gap="lg">
            ...
            <div>
              <Text size="sm" fw={500} mb="xs">
                Notifications <Text span size="xs" c="dimmed">(optional)</Text>
              </Text>
              <Stack gap="sm">
                <Checkbox
                  label="Email"
                ...
                <Checkbox
                  label="Webhook"
                  checked={settingsForm.values.notifications.includes('webhook')}
